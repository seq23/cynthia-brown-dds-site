...
function supportImage(src, alt, cls = '', opts = {}) {
  const loading = opts.loading || 'lazy';
  return `<img class="${esc(cls)}" src="${esc(src)}" alt="${esc(alt)}" width="1400" height="1050" loading="${loading}" decoding="async">`;
}
...
function footer() {
  return `<footer class="footer"><div class="container footer-grid expanded-footer"><div><h3>Dr. Cynthia Brown, DDS</h3><p>Personal professional website for Dr. Cynthia Brown, DDS. Dr. Brown sees patients through her current Olive Branch and Southaven practice locations.</p><p class="fine-print">This site is educational only and does not provide dental or medical advice. Appointment scheduling, insurance, pricing, treatment availability, and office operations are handled through the linked booking pages. Do not submit private health information through this website.</p></div><div><h4>Locations</h4><p><strong>Olive Branch</strong><br>8179 McGregor Crossing<br>Olive Branch, MS 38654<br><a href="${esc(booking.defaultBookingUrl)}">Book / scheduling page</a></p><p><strong>Southaven</strong><br>50 Goodman Road West, STE 2<br>Southaven, MS 38671<br><a href="${esc(booking.defaultBookingUrl)}">Book / scheduling page</a></p></div><div><h4>Hours</h4><p><strong>Olive Branch</strong><br>Mon–Wed: 7:30 AM–5:30 PM<br>Thu: 9:00 AM–7:00 PM<br>Fri: 8:00 AM–1:00 PM<br>Sat–Sun: Closed</p><p><strong>Southaven</strong><br>Hours can vary by appointment availability. Use the linked scheduling page for current times before visiting.</p></div><div><h4>Explore</h4><p><a href="/about/">About</a><br><a href="/services/">Services</a><br><a href="/locations/">Locations</a><br><a href="/resources/">Resources</a><br><a href="/book/">Book</a></p><h4>Legal</h4><p><a href="/privacy/">Privacy</a><br><a href="/disclaimer/">Disclaimer</a></p></div></div></footer>`;
}
function writePage(route, html) { const dir = path.join(dist, route); mkdir(dir); fs.writeFileSync(path.join(dir, 'index.html'), html); }
function hero() {
  return `<section class="hero"><div class="container hero-grid"><div><div class="eyebrow">Olive Branch + Southaven, Mississippi</div><h1 class="word-reveal"><span>Dr.</span> <span>Cynthia</span> <span>Brown,</span> <span>DDS</span></h1><p class="lede">A Memphis native and dentist serving patients through her Olive Branch and Southaven, Mississippi practice locations.</p><div class="script">confidence, carefully considered</div><div class="hero-actions"><a class="btn" href="/book/">Book a Visit</a><a class="btn secondary" href="/locations/">Choose a Location</a><a class="btn secondary" href="/about/">Meet Dr. Brown</a></div></div><div class="portrait-frame hero-portrait full-portrait">${img('cynthia-brown-dds-dental-coat-portrait','Professional portrait of Dr. Cynthia Brown, DDS in a dental coat','', {loading:'eager', fetchpriority:'high'})}</div></div></section>`;
}
function cards() {
  return `<section class="section"><div class="container"><h2 class="section-title">Dental care should feel clear before it feels complicated.</h2><p class="section-copy">This site gives patients a calm place to learn about Dr. Brown’s approach, choose a location, and read practical dental education without pressure, jargon, or shame.</p><div class="grid three"><div class="card"><h3>Clarity</h3><p>Plain-language guidance for patients who want to understand their options before making decisions.</p></div><div class="card"><h3>Confidence</h3><p>A smile-forward point of view that respects health, function, beauty, and real life.</p></div><div class="card"><h3>Care</h3><p>A polished, patient-first experience rooted in respect, warmth, and thoughtful communication.</p></div></div></div></section>`;
}
...
function portraitBand() {
  return `<section class="section alt meet-section"><div class="container split"><div class="editorial-img office-img">${supportImage('/assets/brand/dr-brown-office-coat-photo.png','Photorealistic modern dental office with a coat embroidered Dr. Brown, DDS')}</div><div><div class="eyebrow">Meet Dr. Brown</div><h2 class="section-title">Warmth, precision, and a dentist’s eye for confidence.</h2><p class="section-copy">Dr. Cynthia Brown brings a polished, patient-centered presence to dentistry. Her approach is grounded in clear communication, respect for the person in the chair, and the belief that a confident smile begins with understanding what is healthy, realistic, and right for the individual patient.</p><p class="section-copy">A Memphis native, Dr. Brown attended St. Mary’s School in Memphis before continuing her education at Spelman College and Meharry Medical College School of Dentistry. That path shaped a professional style that values excellence, service, discipline, and care that feels personal rather than rushed.</p><p class="section-copy">Today, she sees patients through her Olive Branch and Southaven, Mississippi practice locations. Whether someone is returning to dental care after time away, asking cosmetic questions, or simply maintaining oral health, her goal is to make the experience feel clear, thoughtful, and grounded in trust.</p><a class="btn secondary" href="/about/">Read Dr. Brown’s Bio</a></div></div></section>`;
}
...
writePage('about', layout('About Dr. Cynthia Brown, DDS', 'Education and personal professional background for Dr. Cynthia Brown, DDS.', pageHero('About Dr. Brown', 'A Memphis native, Spelman graduate, Meharry-trained dentist, and practice owner with locations in Olive Branch and Southaven.') + `<section class="section about-bio"><div class="container split"><div><div class="eyebrow">Biography</div><h2 class="section-title">A professional path shaped by excellence, service, and care that feels personal.</h2><p class="section-copy">Dr. Cynthia Brown is a dentist and practice owner known for combining warmth, precision, and a deeply patient-centered approach to care. A Memphis native, she began her educational journey at St. Mary’s School in Memphis, where she developed the discipline, curiosity, and academic foundation that would help shape her future path.</p><p class="section-copy">She went on to attend Spelman College, graduating with the Class of 2003, and later earned her Doctor of Dental Surgery degree from Meharry Medical College School of Dentistry, Class of 2014. Her education reflects a throughline of excellence, leadership, service, and commitment to communities that deserve thoughtful, high-quality care.</p><p class="section-copy">Over the course of her professional career, Dr. Brown has built a reputation for clear communication, strong clinical judgment, and an eye for the relationship between oral health and smile confidence. She believes patients deserve to understand their options, feel respected in the chair, and leave with more confidence than when they arrived.</p><p class="section-copy">Today, Dr. Brown sees patients through her Olive Branch and Southaven, Mississippi practice locations. Her work reflects a balance of professionalism, compassion, and aesthetic sensibility — especially for patients who are returning to care after time away, considering cosmetic improvements, or looking for ongoing dental care that feels warm and polished.</p><div class="script">care with clarity</div></div><div class="editorial-img full-portrait">${img('cynthia-brown-dds-blush-professional-portrait','Professional blush portrait of Dr. Cynthia Brown')}</div></div></section><section class="section alt"><div class="container"><h2 class="section-title">What patients can expect.</h2><div class="grid three"><div class="card"><h3>Respect</h3><p>A dental visit should not feel embarrassing, rushed, or confusing. Dr. Brown’s public-facing philosophy centers dignity, clarity, and a no-shame return to care.</p></div><div class="card"><h3>Judgment</h3><p>Cosmetic questions, urgent concerns, and routine maintenance all deserve thoughtful clinical evaluation before any treatment decision is made.</p></div><div class="card"><h3>Confidence</h3><p>Smile confidence works best when beauty, comfort, function, and health are considered together — not treated as separate conversations.</p></div></div></div></section>`));
writePage('locations', layout('Locations | Dr. Cynthia Brown, DDS', 'Book care in Olive Branch or Southaven, Mississippi.', pageHero('Locations', 'Choose Olive Branch or Southaven and continue to the current scheduling page for appointment options.') + locationsBlock()));
...
writePage('resources', layout('Resources | Dr. Cynthia Brown, DDS', 'Monthly dental insights and quarterly guides.', pageHero('Resources', 'Insights, guides, and white papers for confident, informed dental care.') + `<section class="section featured-resource"><div class="container split"><div><div class="eyebrow">Featured resource</div><h2 class="section-title">The Smile Confidence Starter Guide</h2><p class="section-copy">Start here before reading deeper monthly insights or quarterly white papers. This resource hub is designed to help patients think clearly about prevention, cosmetic questions, dental anxiety, urgent symptoms, and what to ask before an appointment.</p><a class="btn secondary" href="/smile-philosophy/">Explore the Smile Philosophy</a></div></div></section><section class="section alt"><div class="container"><div class="resource-type-grid"><a class="card resource-type-card" href="#monthly-insights"><span class="tag">Insights</span><h3>Short monthly insights</h3><p>Practical, patient-friendly reflections on dental anxiety, smile confidence, whitening questions, social media trends, and oral-health routines.</p></a><a class="card resource-type-card" href="#white-papers"><span class="tag">White Papers</span><h3>Quarterly deep dives</h3><p>Long-form guides for bigger questions around cosmetic decision-making, returning to care, social media pressure, and year-end planning.</p></a><a class="card resource-type-card" href="/smile-philosophy/"><span class="tag">Philosophy</span><h3>Smile confidence</h3><p>A more personal look at how Dr. Brown thinks about confidence, clarity, and care that respects the whole patient.</p></a><a class="card resource-type-card" href="/book/"><span class="tag">Next step</span><h3>Choose a location</h3><p>When you are ready to schedule, choose Olive Branch or Southaven and continue to the current booking page.</p></a></div></div></section><section class="section" id="monthly-insights"><div class="container"><div class="eyebrow">Now reading</div><h2 class="section-title">Currently published resources</h2><p class="section-copy">Start with the resources below as they are released. New monthly insights and quarterly white papers will appear here after review.</p><h3 class="resource-subhead">Monthly insights</h3>${publicItems.filter(i => i.meta.type === 'monthly_insight').length ? `<div class="resource-grid">${publicItems.filter(i => i.meta.type === 'monthly_insight').map(i => resourceCard(i)).join('')}</div>` : `<p class="section-copy">Monthly insights are currently in review. Approved, date-gated resources will appear here.</p>`}<h3 class="resource-subhead" id="white-papers">Quarterly white papers</h3>${publicItems.filter(i => i.meta.type === 'quarterly_white_paper').length ? `<div class="resource-grid">${publicItems.filter(i => i.meta.type === 'quarterly_white_paper').map(i => resourceCard(i)).join('')}</div>` : `<p class="section-copy">Quarterly white papers are currently in review. Approved, date-gated resources will appear here.</p>`}</div></section>`));
